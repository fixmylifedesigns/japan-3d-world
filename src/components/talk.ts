...
// Hook for voice. Called every time a line is shown, with the language on screen. Each line's `id` is unique
// across every city (the build checks this), so recorded or generated clips (e.g. ElevenLabs) can be stored as
// /voice/<city>/<lang>/<id>.mp3 and played from here.
export function speakLine(city: CityId, line: TalkLine, lang: Lang) {
  void city; void line; void lang;
}
